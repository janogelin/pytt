# removeelements.py
#
# Solutions for removing elements from a list in-place (LeetCode style).
...
if __name__ == "__main__":
    ...
    sol1 = Solution()
    new_len1 = sol1.removeElement(nums1, val1)
    print("After removeElement (Alt 1):", nums1[:new_len1], "Length:", new_len1)

    # Using Solution2 (Alternative 2)
    sol2 = Solution2()
    new_len2 = sol2.removeElement2(nums2, val2)
    print("After removeElement2 (Alt 2):", nums2[:new_len2], "Length:", new_len2) 