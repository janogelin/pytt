...
def main():
    ...
    if args.step:
        ...
        print(f"Generating STEP file: {args.output}")
        ...
        try:
            ...
            print("\nInstructions:")
            print("1. Import the STEP file into Fusion 360 (Insert > Insert CAD).")
            if args.cylinder:
                print("2. The QR code is extruded on top of a cylinder base with an outer railing.")
            else:
                print("2. Each QR code box is already extruded to the specified height.")
        except Exception as err:
            print(f"Error: {err}")
            sys.exit(1)
    else:
        print(f"\n--- Fusion 360 QR Code SVG Generator ---\n")
        print(f"Generating SVG file: {args.output}")
        print(f"URL: {args.url}")
        ...
        try:
            ...
            print("3. Use the 'Extrude' tool to extrude them to the desired height.")
        except Exception as err:
            print(f"Error: {err}")
            sys.exit(1)
